export default {
  ...
  errors: {
    ...
    host_unreachable: 'The host cannot be reached from Outpost.',
    timeout: 'The server did not answer in time.',
    auth_failed: 'The RCON password is wrong.',
    connection_closed: 'The server closed the connection.',
  ...
  servers: {
    ...
    connection: {
      ...
      passwordHint:
        'itzg/minecraft-server: RCON_PASSWORD of the container, or password= in .rcon-cli.env in its data directory.',
      passwordKept: 'Saved; enter a new one to change it',
      test: 'Test',
      save: 'Save',
